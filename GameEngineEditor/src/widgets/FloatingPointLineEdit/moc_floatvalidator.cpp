/****************************************************************************
** Meta object code from reading C++ file 'floatvalidator.h'
**
...
#error "The header file 'floatvalidator.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FloatValidator_t, stringdata) + ofs \
...
const QMetaObject FloatValidator::staticMetaObject = {
    { &QDoubleValidator::staticMetaObject, qt_meta_stringdata_FloatValidator.data,
      qt_meta_data_FloatValidator,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FloatValidator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FloatValidator.stringdata))
        return static_cast<void*>(const_cast< FloatValidator*>(this));
